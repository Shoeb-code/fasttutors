    ...
    <div className="min-h-screen flex items-center justify-center">
      ...
      >
          ...
          <div>
            ...
            <div className="mt-10 space-y-4">
              <h2 className="text-3xl font-bold text-white">
                Learn  <span className="text-amber-600">Better.</span> Score Higher.
              </h2>
              <p className="text-gray-300 bg-gray-900 p-5 rounded-2xl max-w-md leading-relaxed">
        ...
        <div className="p-14 lg:p-16 bg-black/40">
          ...
          <h2 className="text-3xl font-bold text-blue-600 mb-1 flex items-center gap-2">
            <GraduationCap className="text-green-600 "  size={83}/> Find a Tutor
          </h2>
